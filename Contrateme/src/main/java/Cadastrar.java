...
public class Rule_Obj_CaseType_COBK_CourseBo_Work_Bookings_pyDefault_Action_20230219T225239_287_GMT
        extends com.pega.pegarules.priv.AbstractFUASupport implements Activity,
        FUASupport {
    private static final LogHelper oLog = new LogHelper(
            "Rule_Obj_CaseType.pyDefault.COBK_CourseBo_Work_Bookings.Action");

    public Rule_Obj_CaseType_COBK_CourseBo_Work_Bookings_pyDefault_Action_20230219T225239_287_GMT(
            PegaAPI aContext) {
        tools = aContext;
        pega = aContext;
    }
    ...
    public void perform() {
        ...
        mRuleSet = "CourseBo";
        mCaseTypeHandle = "RULE-OBJ-CASETYPE COBK-COURSEBO-WORK-BOOKINGS PYDEFAULT #20230219T225239.287 GMT";
        ...
        if (purpose.equals("ADHOCFLOWS")) {
            ...
            casePage = tools.createPage("COBK-CourseBo-Work-Bookings",
                    "pyTempCallCasePage");
            ...
            initiateCTParams.putParamValue("CurrentStageName", "Busca");
            ...
            tools.putParamValue("CaseLabel", "Bookings");
            fetchCaseCreationInfo();
    ...
    */
    ...
    public String getDefinitionAppliesToClass() {
        return "COBK-CourseBo-Work-Bookings";
    }
    ...
    private void getStages_circum0() {
        ...
        pgStageToAdd.putString(".pyStageName", "Busca");
        ...
        pgStageToAdd.putString(".pyStageName", "Vaga");
        pgStageToAdd.putString(".pyStageTransition", "automatic");
        pgStageToAdd.putString(".pyStageWorkStatus", "");
        pgStageToAdd.putString(".pyCleanupProcess", "");
        pgStageToAdd.putString(".pyResolveChildCases", "");
    ...
    private void getStageName_circum0() {
        ...
        if (!currentStageID.equals("")) {
            if (currentStageID.equals("PRIM0")) {
                tools.putParamValue("StageName", "Busca");
                foundNext = true;
            } else if (currentStageID.equals("PRIM1")) {
                tools.putParamValue("StageName", "Vaga");
                foundNext = true;
    ...
    private void getStageID_circum0() {
        ...
        if (!currentStageName.equals("")) {
            if (currentStageName.equals("Busca")) {
                tools.putParamValue("StageID", "PRIM0");
                foundNext = true;
            } else if (currentStageName.equals("Vaga")) {
    ...
    private void PRIM0_getStageProcessList_circum0() {
        ...
        pgStageProcess.putString("pyLabel", "Buscar Vagas");
    ...
    private void PRIM1_getStageProcessList_circum0() {
        ...
        ClipboardPage pgStageProcess;
        pgStageProcess = tools.createPage("Embed-StageProcess", "");
        pgStageProcess.putString("pyFlowName", "ServiceAccount_Flow");
        pgStageProcess.putString("pxFlowID", "FLOW0");
        pgStageProcess.putString("pyStartWhen", "");
        pgStageProcess.putString("pyLabel", "Vaga Selecionada");
        pgStageProcess.putString("pyStartType", "PARALLEL");
    ...
    private void PRIM0_FLOW0_start_circum0() {
        ...
        if (!pega_rules_utilities.callWhen(tools, "pxIsEmail",
                tools.getPrimaryPage())
                && !tools.getParamValue("isThisReEntry").equals("Yes")) {
            //set parameters
            pega_processengine_workutilities.pzStartStageFlow(
                    tools.getPrimaryPage(), "CreateForm_Default", "FLOW0", "",
                    "");
        } else {
    ...
    private void PRIM1_FLOW0_start_circum0() {
        ...
        //set parameters
        pega_processengine_workutilities.pzStartStageFlow(
                tools.getPrimaryPage(), "ServiceAccount_Flow", "FLOW0", "", "");
    }
    ...
    private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo(
            "RULE-OBJ-CASETYPE COBK-COURSEBO-WORK-BOOKINGS PYDEFAULT #20230219T225239.287 GMT",
            "COBK-CourseBo-Work-Bookings pyDefault", "CourseBo", "01-01-01",
            "20240424T061739.004 GMT");
}
